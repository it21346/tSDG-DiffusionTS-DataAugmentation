...
parser.add_argument("--generate", default = False, dest="generate_samples", help="Generate samples")
parser.add_argument("--gen_data_name", default = "1", dest="gen_data_name", help="Name of destination gen data")
...
if options.generate_samples is not False:
    syn.load_ae()
    syn.load_generator()
    result = syn.synthesize(len(train_set), seq_len = 15)
    with open("{}/data{}".format(root_dir, options.gen_data_name), "wb") as f:
